...
number_hours_worker = int(input("Введите отработанные часы: "))
loan_balance = int(input("Введите остаток по кредиту: "))
amount_money_food = int(input("Введите траты на еду: "))

salary = (200 * number_hours_worker) / 2 ** 3 + number_hours_worker
amount_credit_and_food = loan_balance + amount_money_food

if salary >= amount_credit_and_food:
